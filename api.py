...
static_model = load_model(
    path_to_model='assets/trained-models/load_shortfall_random_forest_regression_model.pkl')
# load_shortfall_random_forest_regression_model
# load_shortfall_simple_lm_regression
